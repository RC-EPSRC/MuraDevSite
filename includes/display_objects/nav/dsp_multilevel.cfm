...
<cfoutput>
<nav id="navMultilevel"<cfif this.navWrapperClass neq ""> class="#this.navWrapperClass#"</cfif> data-id="multinav-sitelevel">
#dspNestedNav(
	...
	listFind(variables.$.content('path'),rsSection.contentID) and arguments.currDepth lt arguments.viewDepth"
)#
</nav>
</cfoutput>