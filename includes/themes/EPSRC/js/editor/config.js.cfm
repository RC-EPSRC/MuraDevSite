...
CKEDITOR.editorConfig = function( config )
{
	...
	config.toolbar_Default = [
	                                	...
	                                	{name: 'group9', items:['Image','Flash','Media','gmap','-','Table','HorizontalRule','SpecialChar','Equation','PageBreak','-','Selectlink','SelectComponent','Templates'<cfif application.configBean.getEnableMuraTag()>,'muratag'</cfif>]},
	...
	config.toolbar_Summary = [
										...
										['Link','Unlink','Anchor'],
										['Image','Flash','Media','gmap','-','Table','HorizontalRule','SpecialChar','Equation','PageBreak','-','Selectlink','SelectComponent','Templates'<cfif application.configBean.getEnableMuraTag()>,'muratag'</cfif>],
	...
	config.extraPlugins = config.extraPlugins + ",muratag,equation";
	</cfif>
