			...
			<fieldset>
				...
				<ol>
					<li class="req control-group">
						<div>
							<div class="formLeft">
								<label class="control-label" for="txtName">#variables.$.rbKey('comments.name')# <b>#variables.$.rbKey('comments.required')#</b></label>
							</div>
							<div class="formRight">
					...
					<li class="req control-group">
						<div>
							<div class="formLeft">
								<label class="control-label" for="txtEmail">#variables.$.rbKey('comments.email')# <b>#variables.$.rbKey('comments.required')#</b></label>
							</div>
							<div class="formRight">
			   ...
			   <!---<li class="control-group">
					...
					<li class="req control-group">
						<div>
							<div class="formLeft">
								<label for="txtComment" class="control-label">#variables.$.rbKey('comments.comment')# <b>#variables.$.rbKey('comments.required')#</b></label>
							</div>
							<div class="formRight">
