						...
						<cfelse>
							<cfloop from="1" to="#variables.feedData.maxItems#" index="i">
								<dl<cfif (i EQ 1)> class="first"<cfelseif (i EQ variables.feedData.maxItems)> class="last"</cfif>>
									...
									<cfif arguments.hasSummary and structKeyExists(variables.feedData.itemArray[i],"summary")><dd class="summary">#replacenocase(variables.feedData.itemArray[i].summary.xmlText, '<p>&nbsp;</p>', '', 'all')#</dd></cfif>
								</dl>
							</cfloop>
						</cfif>
					</cfif>
