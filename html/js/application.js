$(document).ready(function () {
    ...
    $('#content .media_option_links p.filter').on('click', 'a', function (e) {
        var activeClass = $(this).attr('class').replace(' active', '');
        $('#content .media_option_links p.filter a').removeClass('active');
        $(this).addClass('active');
        $('#content .media_option_links div.filter div').fadeOut(0);
        $('#content .media_option_links div.filter div.' + activeClass).fadeIn(animateTime / 4, easing);
...
function fireFunctions(size) {
    ...
    if (size == 'core') {
        ...
        var secondaryNav = $('header .media_option_links ul').clone().addClass('secondary');
...
function openArea(triggerClass, animate) {
    ...
    $('header .primary .nav li.' + triggerClass + ' a').addClass('hover');
